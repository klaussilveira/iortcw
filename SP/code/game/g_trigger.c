...
void trigger_aidoor_stayopen(gentity_t* ent, gentity_t* other, trace_t* trace)
{
    ...
    if (other->client && other->health > 0) {
        ...
        if (other->r.svFlags & SVF_CASTAI) {
            ...
            if (
            (door->grenadeFired > level.time) || (!((door->activator == other) && (door->moverState != MOVER_POS1) && (door->moverState != MOVER_POS1ROTATE)) && (door->moverState != MOVER_POS2ROTATE) && (door->moverState != MOVER_POS2))) {
