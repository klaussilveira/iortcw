...
** Print progress
*/
BOOL HTAlertCallback_progress(HTRequest* request, HTAlertOpcode op, int msgnum, const char* dfault, void* input, HTAlertPar* reply)
{
    if (op == HT_PROG_READ) {
        if (!dl_is_ftp) {
...
*/
BOOL HTAlertCallback_confirm(HTRequest* request, HTAlertOpcode op, int msgnum, const char* dfault, void* input, HTAlertPar* reply)
{
...
*/
BOOL HTAlertCallback_prompt(HTRequest* request, HTAlertOpcode op, int msgnum, const char* dfault, void* input, HTAlertPar* reply)
{
