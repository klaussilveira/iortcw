...
OSStatus AttachMLTEToWindow(WindowRef inWindow, TXNObject* outObject)
{
    ...
    frameOptions = kTXNWantVScrollBarMask | kTXNNoKeyboardSyncMask | kTXNAlwaysWrapAtViewEdgeMask;
...
void SetMLTECarbonEvents(WindowRef inWindow, TXNObject inTextObject)
{
    ...
    carbonEventInfo.fDictionary = CFDictionaryCreate(kCFAllocatorDefault,
    (const void**)&keys,
...
OSStatus AttachEditableMLTEToWindow(WindowRef inWindow, TXNObject* outObject)
{
    ...
    frameOptions = kTXNSingleLineOnlyMask | kTXNNoKeyboardSyncMask | kTXNAlwaysWrapAtViewEdgeMask;
...
void Sys_Print(const char* text)
{
    ...
    if ((com_developer && com_developer->integer) || (com_dedicated && com_dedicated->integer)) {
