...
void CG_CheckLocalSounds(playerState_t* ps, playerState_t* ops)
{
    ...
    if (cgs.timelimit > 0 && cgs.gamestate == GS_PLAYING) {
        ...
        if (cgs.timelimit > 5 && !(cg.timelimitWarnings & 1) && (msec > (cgs.timelimit - 5) * 60 * 1000) && (msec < (cgs.timelimit - 5) * 60 * 1000 + 1000)) {
        ...
        if (cgs.timelimit > 2 && !(cg.timelimitWarnings & 2) && (msec > (cgs.timelimit - 2) * 60 * 1000) && (msec < (cgs.timelimit - 2) * 60 * 1000 + 1000)) {
        ...
        if (!(cg.timelimitWarnings & 4) && (msec > (cgs.timelimit) * 60 * 1000 - 30000) && (msec < (cgs.timelimit) * 60 * 1000 - 29000)) {
