...
void AAS_SetTexinfo(mapbrush_t* brush)
{
    ...
    if (brush->contents & (CONTENTS_LADDER | CONTENTS_AREAPORTAL | CONTENTS_CLUSTERPORTAL | CONTENTS_TELEPORTER | CONTENTS_JUMPPAD | CONTENTS_DONOTENTER | CONTENTS_DONOTENTER_LARGE | CONTENTS_WATER | CONTENTS_LAVA | CONTENTS_SLIME | CONTENTS_WINDOW | CONTENTS_PLAYERCLIP | CONTENTS_MONSTERCLIP | CONTENTS_MOVER)) {
...
int AAS_ValidEntity(entity_t* mapent)
{
    ...
    else if (!strcmp("func_door_rotating", ValueForKey(mapent, "classname")) || !strcmp("func_door", ValueForKey(mapent, "classname")) || !strcmp("func_invisible_user", ValueForKey(mapent, "classname"))) {
...
void AAS_CreateMapBrushes(mapbrush_t* brush, entity_t* mapent, int addbevels)
{
    ...
    */
    ...
    if (!(brush->contents & (CONTENTS_SOLID | CONTENTS_LADDER | CONTENTS_CLUSTERPORTAL | CONTENTS_DONOTENTER | CONTENTS_DONOTENTER_LARGE | CONTENTS_TELEPORTER | CONTENTS_JUMPPAD | CONTENTS_WATER | CONTENTS_LAVA | CONTENTS_SLIME | CONTENTS_MOVER))) {
        nummapbrushsides -= brush->numsides;
        brush->numsides = 0;
        return;
    } // end if
