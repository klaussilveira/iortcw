                        ...
                        for (i = 0; token[0]; i++) {
                            ...
                            if (i == 0) {
                                ...
                                if (!Q_stricmp(action->actionString, "playsound")) {
                                    ...
                                    G_ModelIndex(token);
                                } else if (buildScript && (!Q_stricmp(action->actionString, "mu_start") || !Q_stricmp(action->actionString, "mu_play") || !Q_stricmp(action->actionString, "mu_queue") || !Q_stricmp(action->actionString, "startcam"))) {
